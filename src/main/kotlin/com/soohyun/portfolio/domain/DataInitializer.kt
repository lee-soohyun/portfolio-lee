package com.soohyun.portfolio.domain

import com.soohyun.portfolio.domain.constant.SkillType
import com.soohyun.portfolio.domain.entity.*
import com.soohyun.portfolio.domain.repository.*
    ...
    fun initializeData() {
        ...
        val achievements = mutableListOf<Achievement> (
            Achievement(
                ...
                description = "고양이 쇼핑몰 검색 서비스의 아키텍쳐, 데이터 모델링, API 개발 역할",
                host = "캣카오",
        ...
        val kotlin = Skill(name = "Kotiln", type = SkillType.LANGUAGE.name, isActive = true)
